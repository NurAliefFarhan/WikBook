...
@section('content')
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboardAdmin/admin">
                            ...
                            <div class="row justify-content-center ">
                                <div class="col-xl-10">
                                    <div class="card shadow-lg ">
                                        ...
                                        <form action="{{route('wikbook.updatebook', $libraries['id'])}}" method="POST" enctype="multipart/form-data">
                                            @csrf 
                                            @method('PATCH')
                                            @if ($errors->any())
                                            {{-- alert kalau tidak di isi, akan muncul alert denger  --}}
                                                ...
                                                <div class="row-md-8" style="width: 90%;">
                                                    <div class="card border-0" style="width: 100%;">
                                                        <div class="card-header pb-0">
                                                            <center>
                                                                <h2 class="card-title space">Form Update Book</h2>
                                                            </center>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control form-control-sm" name="title" id="NAME" aria-describedby="helpId" placeholder="Masukkan Judul Buku" value="{{$libraries['title']}}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="NAME" class="small text-muted mb-1">Writer</label>
                                                                <input type="text" class="form-control form-control-sm" name="writer" id="NAME" aria-describedby="helpId" placeholder="Masukkan Nama penulis" value="{{$libraries['writer']}}">
                                                            </div>
                                                            ...
                                                            <div class="row no-gutters">
                                                                <div class="col-sm-6 pr-sm-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-sm" name="publisher" id="NAME" aria-describedby="helpId" placeholder="Masukkan Nama Penerbit" value="{{$libraries['publisher']}}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label for="NAME" class="small text-muted mb-1">No.ISBN</label>
                                                                        <input type="number" class="form-control form-control-sm" name="isbn" id="NAME" aria-describedby="helpId" placeholder="978-602-8519-93-9" value="{{$libraries['isbn']}}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 pr-sm-2">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea class="form-control" type="text" name="synopsis" id="NAME" rows="1" aria-describedby="helpId" placeholder="Masukkan Synopsis">{{$libraries['synopsis']}}</textarea>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row-sm-6" style="width: 100%;">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <img src="{{asset('storage/image/' . $libraries->image)}}" style="height:10%; width:10%; margin-top:1%; border-radius:3px;">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row mb-md-5 mt-4">
                                                                <div class="col">
                                                                    <button type="submit" name="submit" id="" class="btn  btn-lg btn-block ">Update Data Buku</button>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <a href="/wikbook/dashboardAdmin/book" class="btn btn-primary">Back</a>
                                                                </div>
                                                            </div>    
                                                        </div>
                                                    </div>
